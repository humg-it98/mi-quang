                ...
                <form action="{{route('roles.store')}}" method="post" enctype="multipart/form-data" style="width:100%">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="display_name" rows="3" class="form-control" placeholder="Mô tả vai trò">{{old('display_name')}}</textarea>
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12">
                                <label><input type="checkbox" class="checkall">Chọn tất cả quyền</label>
                            </div>
