                    ...
                    <form action="{{route('products.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="pro_name" value="{{old('pro_name')}}"class="form-control" placeholder="Nhập tên sản phẩm">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="pro_price" value="{{old('pro_price')}}" id="price" class="form-control">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" name="pro_sale" value="{{old('pro_sale')}}" id="price" class="form-control">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="pro_content" placeholder="Nội dung mô tả">{{old('pro_content')}}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" name="pro_description" id="content" rows="3" placeholder="Nội dung mô tả chi tiết">{{old('pro_description')}}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <div>
                                <input type="radio" id="active" value="1" name="pro_active" checked="">
                                <label for="active" >Có</label>
                            </div>
                            <div>
                                <input type="radio" id="no_active" value="0" name="pro_active">
