...
@section('css')
    <style>
        ...
        .bg3 {
            background-image: url('public/user/teamplate/img/bg_footer.png');
        }
...
@section('main-home')
    <main>
        <div class="hero_single inner_pages background-image" data-background="url(/admin/teamplate/img/Reservation.jpg)">
            ...
            <div
                ...
                <div
                    ...
                    <p class="flex flex-col items-center text-gray-500 justify-center mt-10 text-center">
                        ...
                        <a href="/dang-ky" class=" px-3 py-2 text-lg font-semibold text-yellow-500 transition-colors duration-300 bg-white rounded-md shadow hover:bg-white-600 focus:outline-none focus:ring-white-200 focus:ring-4">
                            Đăng ký ngay!
                        </a>
                    </p>
                </div>
                <div class="p-5 bg-white md:flex-1">
                    <h3 class="text-2xl font-semibold text-gray-900">Đăng nhập tài khoản Admin</h3>
                    <p class="my-2 font-semibold text-gray-800">Để quản lý chức năng!</p>


                    <form class="flex flex-col space-y-5" action="{{route('loginAuth')}}" method="POST">
                        @csrf
                        ...
                        <div class="flex flex-col space-y-5">
                            ...
                            <div class="flex flex-col space-y-4">
                                <a href="{{ route('google.login') }}" class="flex items-center justify-center px-4 py-2 space-x-2 transition-colors duration-300 border border-gray-800 rounded-md group hover:bg-gray-800 focus:outline-none">
